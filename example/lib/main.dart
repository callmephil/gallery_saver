...
class _MyAppState extends State<MyApp> {
  ...
  void _takePhoto() async {
    ...
    final result =
        await GallerySaver.saveImage(pickedImage.path, albumName: albumName);

    if (result case final success?) {
      if (!mounted) return;
  ...
  void _recordVideo() async {
    ...
    if (pickedVideo == null || pickedVideo.path.isEmpty) {
      return;
    }
    ...
    final result =
        await GallerySaver.saveVideo(pickedVideo.path, albumName: albumName);
